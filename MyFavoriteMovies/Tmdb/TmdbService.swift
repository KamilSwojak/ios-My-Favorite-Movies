...
class TmdbService{
    ...
    public func setApiKey(_ key: String){
        TmdbServerConfig.shared.setApiKey(key)
    }
        
    //MARK: Account
    
    /// Get your account details.
    func getAccountDetails(sessionId: String) -> Observable<GetAccountDetailsResponse>{
        let path = "account"

        let queries: [String : Any] = [Key.session_id : sessionId]
        
        return requestJson(path: path, queries: queries)
    }
    
    /// Get all of the lists created by an account. Will invlude private lists if you are the owner.
    func getCreatedLists(accountId: Int, sessionId: String, page: Int! = 1) -> Observable<GetCreatedListsResponse> {
        let path = "/account/\(accountId)/lists"

        var queries: [String : Any] = [:]
        queries[Key.language] = language
        queries[Key.session_id] = sessionId
    ...
    func getFavoriteMovies(accountId: Int, sessionId: String, page: Int! = 1, sortBy: TmdbSort? = .CreatedAtAscending) -> Observable<GetFavoriteMoviesResponse>{
    ...
    func getFavoriteTVShows(accountId: Int, sessionId: String, page: Int! = 1, sortBy: TmdbSort? = .CreatedAtAscending) -> Observable<GetFavoriteTVShowsResponse>{
    ...
    func markAsFavorite(mediaType: TmdbMediaType, mediaId: Int, favorite: Bool, accountId: Int, sessionId: String) -> Observable<MarkAsFavoriteResponse>{
    ...
    func getRatedMovies(accountId: Int, sessionId: String, page: Int! = 1, sortBy: TmdbSort? = .CreatedAtAscending) -> Observable<GetRatedMoviesResponse> {
    ...
    func getRatedTVShows(accountId: Int, sessionId: String, page: Int! = 1, sortBy: TmdbSort? = .CreatedAtAscending) -> Observable<GetRatedTVShowsResponse> {
    ...
    func getRatedTVEpisodes(accountId: Int, sessionId: String, page: Int! = 1, sortBy: TmdbSort? = .CreatedAtAscending) -> Observable<GetRatedTVEpisodesResponse>{
    ...
    func getMovieWatchlist(accountId: Int, sessionId: String, page: Int! = 1, sortBy: TmdbSort? = .CreatedAtAscending) -> Observable<GetMovieWatchlistResponse> {
    ...
    func getTvShowWatchlist(accountId: Int, sessionId: String, page: Int! = 1, sortBy: TmdbSort? = .CreatedAtAscending) -> Observable<GetTVShowsWatchlistResponse> {
    ...
    func addToWatchlist(mediaType: TmdbMediaType, mediaId: Int, watchlist: Bool, accountId: Int, sessionId: String) -> Observable<AddToWatchlistResponse> {
    ...
    func createSession(requestToken: String) -> Observable<CreateSessionResponse> {
    ...
    func discoverMovies(queries: MovieDiscoverQueries?, page: Int! = 1) -> Observable<DiscoverMovieResponse>{
        ...
        return requestJson(path: path, queries: (queries as Query).mapQueries())
    }
    ...
    func getMovieAccountStates(movieId: Int, sessionId: String) -> Observable<GetAccountStatesResponse> {
    ...
    /// Rate a movie.
    func rateMovie(movieId: Int, value: RatingScale, sessionId: String) -> Observable<PostRateMovieResponse> {
    ...
    func deleteRating(movieId: Int, sessionId: String) -> Observable<TmdbResponse> {
        let path = "/movie/\(movieId)/rating"
    ...
    /// - If it belongs to your watchlist
    /// - If it belongs to your favourite list
    func getTvShowAccountStates(tvId: Int, sessionId: String) -> Observable<GetAccountStatesResponse> {
    ...
    /// Rate a TV show.
    func rateTVShow(tvId: Int, value: RatingScale, sessionId: String) -> Observable<PostRateTVShowResponse> {
    ...
    func deleteTVShowRating(tvId: Int, sessionId: String) -> Observable<TmdbResponse>  {
        let path = "/tv/\(tvId)/rating"
    ...
    func getTVSeasonAccountStates(tvId: Int, seasonNumber: Int, sessionId: String) -> Observable<GetAccountStatesResponse> {
    ...
    func getTVEpisodeAccountStates(tvId: Int, seasonNumber: Int, episodeNumber: Int, sessionId: String) -> Observable<GetAccountStatesResponse> {
    ...
    /// Rate a TV episode.
    func rateTVEpisode(tvId: Int, seasonNumber: Int, episodeNumber: Int, value: RatingScale, sessionId: String) -> Observable<PostRateTVEpisodeResponse> {
    ...
    func deleteTVEpisodeRating(tvId: Int, seasonNumber: Int, episodeNumber: Int, sessionId: String) -> Observable<TmdbResponse> {
        let path = "/tv/\(tvId)/season/\(seasonNumber)/episode/\(episodeNumber)/rating"
